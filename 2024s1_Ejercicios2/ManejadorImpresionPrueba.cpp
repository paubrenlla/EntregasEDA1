...
void ManejadorImpresionPrueba::imprimirResultado(TipoRetorno retorno, TipoRetorno retornoEsperado, const char* comentario, bool paraParseo) const
{
	if (paraParseo)
	{
...
const char* ManejadorImpresionPrueba::getStringRetorno(TipoRetorno retorno)const
{
	switch( retorno )
	{
		case OK: 
